...
class punch(pygame.sprite.Sprite):
    def __init__(self,player,game):
        ...
        self.player = player
        self.type = 0
        self.image = pygame.image.load("src/Service/Perso2/graphismes/fist.png")
    ...
    def move(self):
        ...
        if not (self.game.check_colision(self,self.player.enemys)):
            ...
            if not self.player.enemy.parade:
                self.player.health += self.player.fistDmg * self.player.life_steal
